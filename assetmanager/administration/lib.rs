...
pub use self::administration::Administration;
use ink_lang as ink;
...
pub mod administration {
    ...
    //     #[test]
    //     fn default_works() {
    //         let adminstration = Administration::default();
    ...
    //     #[test]
    //     fn enable_works() {
    //         let mut adminstration = Administration::new(7_0, 100_0, false);
    //         assert_eq!(adminstration.is_enabled(), false);
    ...
    //     #[test]
    //     fn disable_works() {
    //         let mut adminstration = Administration::new(7_0, 100_0, true);
    //         assert_eq!(adminstration.is_enabled(), true);
    //         assert_eq!(adminstration.get_interest_rate(), 7_0);
    //         assert_eq!(adminstration.get_transfer_rate(), 100_0);
